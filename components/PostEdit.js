...
const PostEdit = ({ titlename, title, content, message, tags, series, csrfToken, set, functions }) => {
    return (
        <>
            ...
            <PostEditLayout titlename={titlename}>
                <form method="POST" className="post-form" encType="multipart/form-data" onKeyDown={e => { { functions.dontSubmit(e) } }}>
                    ...
                    <div className="">
                        ...
                        <input className={[postStyle['text-input'], postStyle['sm-input']].join(" ")} name="title" type="text"
                            value={title} onChange={e => { set.setTitle(e.target.value) }} required />
                    </div>
                    <div className="">
                        <label className="form-label">內文</label>
                        <textarea id="content" className={[postStyle['text-input'], postStyle['lg-input']].join(" ")} name="content" type="text"
                    ...
                    <div className="">
                        ...
                        <input className={[postStyle['text-input'], postStyle['sm-input']].join(" ")} name="series" type="text"
                ...
                <>
                    <h3>預覽</h3>
                    <div className={`${postStyle.preview} border`}>
